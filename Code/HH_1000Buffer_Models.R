...
save(rpart_tree1000, file="FinalModels/rpart.RData", overwrite=T)
...
save(rF1000, file="FinalModels/randomForest.RData", overwrite=T)
...
#save model to file
save(rfcaret_1000, file="FinalModels/rfCaret.Rdata", overwrite=T))
...
save(gbm_tree1000, file="FinalModels/gbm.Rdata", overwrite=T))
...
save(xgb_train_1, file= "xgb.rda", overwrite=T))
