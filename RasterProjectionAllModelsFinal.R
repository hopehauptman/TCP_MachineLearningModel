...
# back transform raster values to remove log
rfcaret_trans = exp(r_pred_CARET)
plot(rfcaret_trans)
...
# back transform raster values to remove log
ranger_trans = exp(r_pred_ranger)
plot(ranger_trans)
