#Machine Learning Models for TCP Prediction 4/2/22 ####
...
write.csv(rF_train1000, "C:/Users/bhauptman/Box/Ch2/R/data/rF_train1000.csv")
write.csv(rF_test1000, "C:/Users/bhauptman/Box/Ch2/R/data/rF_test1000.csv")
...
#save file
saveRDS(rF1000, "FinalModels/rF1000.Rds")
...
write_xlsx(caretVarImp,"C:/Users/bhauptman/Box/Ch2/R/data/caretVarImp.xlsx")

#4 also try method = ranger#################################
set.seed(333)
library(ranger)
...
save(ranger_tree1000, file="ranger_tree1000")

ranger_test1000 <- predict(ranger_tree1000, newdata = dftest1000)
ranger_test1000

write.csv(ranger_train1000, "C:/Users/bhauptman/Box/Ch2/R/data/ranger_train1000.csv")
write.csv(ranger_test1000, "C:/Users/bhauptman/Box/Ch2/R/data/ranger_test1000.csv")

#save file
saveRDS(ranger_tree1000, "FinalModels/ranger_tree1000.Rds")
...
#save file
saveRDS(xgb_train_1, "FinalModels/xgb_train_1.Rds")
...
save(xgbc, file="FinalModels/xgboost.RData", overwrite=T)

#save file
saveRDS(xgbc, "FinalModels/xgbc.Rds")
...
write.csv(pred_y_train, "C:/Users/bhauptman/Box/Ch2/R/data/pred_y_train.csv")
write.csv(pred_y_test, "C:/Users/bhauptman/Box/Ch2/R/data/pred_y_test.csv")
...
#######OLD I think I can delete below if the above works#####################################
# ############################BOOSTED MODELS#################################################
# 
...
# 
# ##################################################################################################
# cv.ctrl <- trainControl(method = "repeatedcv", repeats = 1, number = 3, allowParallel=T)
# ###BUFFEER=1000meters#######################################################################################
# 
# #### 6 xgboost in CARET package ##################################################################
# set.seed(888)
# 
# # Tune model xgboost in Caret 
# xgbCaret_grid_1 <- expand.grid(
...
# 
# # write and/or load the model to a file and to load file next time: 
# save(xgb_train_1, file= "FinalModels/xgb.rda", overwrite=T)
# 
# ####Error TRAINING##############################################################################
# #GBM
